              ...
              <div className={styles.contactDetails}>
                ...
                <div className={styles.contactItem}>
                  ...
                  <div>
                    ...
                    <p className={`${isDarkMode ? styles.darkSubtitle : styles.lightSubtitle}`}>+91 9599 196874</p>
                  </div>
                </div>
                ...
                <div className={styles.contactItem}>
                  ...
                  <div>
                    ...
                    <p className={`${isDarkMode ? styles.darkSubtitle : styles.lightSubtitle}`}>info@metasense.in</p>
                  </div>
                </div>
                ...
                <div className={styles.contactItem}>
                  ...
                  <div>
                    ...
                    <p className={`${isDarkMode ? styles.darkSubtitle : styles.lightSubtitle}`}>Mon - Sat: 9:00 AM - 6:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
